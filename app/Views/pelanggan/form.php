    ...
    <div class="col-md-7">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold">Tambah Data Laundry</h6>
            </div>
            <div class="card-body">
                <form action="/pelanggan/simpan" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="berat" class="form-control" id="berat" placeholder="Masukan Berat">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="tglMasuk" class="form-control" id="tglMasuk" placeholder="Masukan Tanggal">
                    </div>
                    <div class="form-group">
                        <label for="tglKeluar">Tanggal Keluar</label>
                        <input type="date" name="tglKeluar" class="form-control" id="tglKeluar" placeholder="Masukan Tanggal">
                    </div>
                    <div class="form-group">
